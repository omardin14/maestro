...
from maestro.runner.workflow_config import (
    ClaudeConfig,
    HooksConfig,
    ServiceConfig,
    StateConfig,
...
from maestro.linear_client import LinearClient
from maestro.models import Issue, RetryEntry, RunAttempt
from maestro.runner.prompt_assembler import assemble_prompt, build_lifecycle_section
from maestro.runner.agent_runner import run_agent_turn, run_turn
from maestro.runner.tracking import make_gate_comment, make_state_comment, parse_latest_tracking
from maestro.runner.workspace import ensure_workspace, remove_workspace
    ...
    async def _run_worker(self, issue: Issue, attempt: RunAttempt):
        ...
        try:
            ...
            if state_cfg and state_cfg.hooks and state_cfg.hooks.on_stage_enter:
                from maestro.runner.workspace import run_hook
                ok = await run_hook(
