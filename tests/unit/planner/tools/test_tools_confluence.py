...
class TestConfluenceSearchDocs:
    def test_happy_path_returns_titles_and_urls(self, monkeypatch):
        ...
        monkeypatch.setattr("maestro.planner.tools.confluence._make_confluence_client", lambda: mock_client)
    ...
    def test_missing_config_returns_message(self, monkeypatch):
        monkeypatch.setattr("maestro.planner.tools.confluence._make_confluence_client", lambda: None)
...
class TestConfluenceReadPage:
    ...
    def test_no_page_id_or_title_returns_error(self, monkeypatch):
        monkeypatch.setattr("maestro.planner.tools.confluence._make_confluence_client", lambda: MagicMock())
