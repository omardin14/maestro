...
from maestro.planner.tools.llm_tools import (
    _FIBONACCI_POINTS,
    estimate_complexity,
...
class TestEstimateComplexity:
    def test_returns_llm_response(self, monkeypatch):
        ...
        monkeypatch.setattr("maestro.planner.tools.llm_tools.get_llm", lambda **kw: mock_llm)
    ...
    def test_error_returns_error_string(self, monkeypatch):
        ...
        monkeypatch.setattr("maestro.planner.tools.llm_tools.get_llm", lambda **kw: mock_instance)
    ...
    def test_uses_low_temperature(self, monkeypatch):
        ...
        monkeypatch.setattr("maestro.planner.tools.llm_tools.get_llm", mock_get_llm)
