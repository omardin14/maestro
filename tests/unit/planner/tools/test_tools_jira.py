...
from maestro.planner.tools import get_tools  # noqa: E402 — stdlib/local separation handled by ruff
...
class TestJiraReadBoard:
    def test_happy_path_returns_board_info(self, monkeypatch):
        ...
        monkeypatch.setattr("maestro.planner.tools.jira._make_jira_client", lambda: mock_client)
    ...
    def test_missing_config_returns_message(self, monkeypatch):
        monkeypatch.setattr("maestro.planner.tools.jira._make_jira_client", lambda: None)
