...
from maestro.planner.guardrails import (
    MAX_INPUT_CHARS,
    _passes_allowlist,
    check_input_length,
    check_off_topic,
...
_LLM_PATCH = "maestro.planner.llm.get_llm"
_PROVIDER_PATCH = "maestro.config.get_llm_provider"
...
class TestValidateInput:
    def test_clean_input_returns_none(self):
        with patch("maestro.planner.guardrails.check_off_topic", return_value=None):
    ...
    @patch("maestro.planner.guardrails.check_off_topic")
    ...
    def test_profanity_before_llm_call(self):
        with patch("maestro.planner.guardrails.check_off_topic") as mock_classifier:
