...
from maestro.planner.state import Priority, StoryPointValue
from maestro.planner.prompts.epic_generator import MAX_EPICS
from maestro.planner.prompts.story_writer import MAX_STORIES_PER_EPIC
...
class TestVagueProjectDescriptions:
    ...
    def test_minimal_json_uses_defaults_for_missing_fields(self):
        ...
        from maestro.planner.state import ProjectAnalysis
