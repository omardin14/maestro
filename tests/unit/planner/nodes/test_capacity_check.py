...
from maestro.planner.state import QuestionnaireState
...
class TestFetchJiraVelocity:
    ...
    @patch("maestro.planner.tools.jira.jira_fetch_velocity")
...
class TestDetectBankHolidaysForWindow:
    ...
    @patch("maestro.planner.tools.calendar_tools._detect_country_from_locale", return_value=None)
    ...
    @patch("maestro.planner.tools.calendar_tools._detect_country_from_locale", return_value="GB")
    @patch(
        "maestro.planner.tools.calendar_tools.get_bank_holidays_structured",
        return_value=[
    ...
    @patch("maestro.planner.tools.calendar_tools._detect_country_from_locale", return_value="GB")
    @patch("maestro.planner.tools.calendar_tools.get_bank_holidays_structured", return_value=[])
...
class TestPrepareBankHolidayChoices:
    ...
    @patch("maestro.planner.tools.calendar_tools.detect_bank_holidays")
