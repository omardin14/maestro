...
from maestro.planner.nodes import route_entry
...
class TestRouteEntryImports:
    ...
    def test_importable_from_agent_package(self):
        from maestro.planner import route_entry as imported_fn

        assert imported_fn is route_entry

    def test_importable_from_nodes_module(self):
        from maestro.planner.nodes import route_entry as imported_fn
