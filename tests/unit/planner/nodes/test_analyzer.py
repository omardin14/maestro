...
from maestro.planner.prompts.intake import QUESTION_DEFAULTS
...
class TestProjectAnalyzer:
    ...
    def test_returns_project_analysis(self, monkeypatch):
        ...
        monkeypatch.setattr("maestro.planner.nodes.get_llm", lambda **kw: mock_llm)
...
class TestScanRepoContext:
    ...
    def test_github_calls_read_repo_and_readme(self, monkeypatch):
        ...
        monkeypatch.setattr("maestro.planner.tools.github.github_read_repo", mock_repo)
        monkeypatch.setattr("maestro.planner.tools.github.github_read_readme", mock_readme)
    ...
    def test_azdo_platform_calls_azdevops_read_repo(self, monkeypatch):
        ...
        monkeypatch.setattr("maestro.planner.tools.azure_devops.azdevops_read_repo", mock_fn)
...
class TestProjectAnalyzerRepoContext:
    ...
    def test_includes_repo_context_when_scan_succeeds(self, monkeypatch):
        ...
        monkeypatch.setattr("maestro.planner.nodes.get_llm", lambda **kw: mock_llm)
        monkeypatch.setattr(
            "maestro.planner.nodes._scan_repo_context",
...
class TestFetchConfluenceContext:
    ...
    def test_returns_none_when_search_errors(self, monkeypatch):
        ...
        monkeypatch.setattr("maestro.planner.tools.confluence.confluence_search_docs", mock_tool)
...
class TestProjectAnalyzerConfluenceContext:
    ...
    def test_includes_confluence_context_when_fetch_succeeds(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "maestro.planner.nodes._fetch_confluence_context",
            lambda _qs: (
...
class TestLoadUserContext:
    ...
    def test_docs_dir_respects_budget(self, tmp_path):
        ...
        from maestro.planner.tools.codebase import _MAX_DOCS_CHARS
...
class TestProjectAnalyzerUserContext:
    ...
    def test_user_context_passed_to_prompt_when_present(self, monkeypatch):
        ...
        monkeypatch.setattr("maestro.planner.nodes.get_analyzer_prompt", mock_prompt)
