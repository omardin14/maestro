...
class TestGetAnalyzerPrompt:
    ...
    def test_importable_from_analyzer_module(self):
        """get_analyzer_prompt should be importable from maestro.planner.prompts.analyzer."""
        from maestro.planner.prompts.analyzer import get_analyzer_prompt as imported_fn
